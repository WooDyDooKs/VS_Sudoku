...
public interface ServerMessageHandler {
    ...
    /**
     * Will be invoked when a new raw message from the server is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
     *            The {@link Message} generated from the incoming data.
     */
    ...
    /**
     * Will be invoked when a new leave message from the server is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
    ...
    /**
     * Will be invoked when a new invitation from a directed invite is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
    ...
    /**
     * Will be invoked when a new error message from the server is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
    ...
    /**
     * Will be invoked when a new NACK message from the server is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
    ...
    /**
     * Will be invoked when a new game over message from the server is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
    ...
    /**
     * Will be invoked when a new score message from the server is received.
     * 
     * @param server
     *            The {@link Server} who sent the message.
     * @param message
