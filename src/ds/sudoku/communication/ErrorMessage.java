...
/**
 * This message is sent whenever a participant encounters an error or an
 * exception.
 * 
 * @author dalhai
 * 
...
public class ErrorMessage extends Message {
    ...
    /**
     * Create a new {@link ErrorMessage} with the given error constant as
     * reason.
     * 
     * @param error
     *            The error associated with this error message.
     */
