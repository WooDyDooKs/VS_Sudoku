 ...
 * 
 */
public class DeregisterMessageAdapter extends MessageSerializer implements
		JsonSerializer<DeregisterMessage>, JsonDeserializer<DeregisterMessage> {
	...
	public DeregisterMessage deserialize(JsonElement jsonMessage, Type type,
		...
		// Extract reason
		JsonElement reasonElement = jsonMessageObject
		...
		final String token = tokenElement != null ? tokenElement.getAsString()
				: null;

		return new DeregisterMessage(reason, token, customValues,
				customProperties);
	}
