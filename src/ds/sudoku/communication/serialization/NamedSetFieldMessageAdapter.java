...
/**
 * Json adapter used to serialize and deserialize {@link NamedSetFieldMessage}.
 * 
 * @author dalhai
 * 
 */
public class NamedSetFieldMessageAdapter extends MessageSerializer implements
		JsonSerializer<NamedSetFieldMessage>,
		JsonDeserializer<NamedSetFieldMessage> {

	/**
	 * Deserialize the given {@link JsonElement} to a
	 * {@link NamedSetFieldMessage}.
	 * 
	 * @param jsonMessage
	 ...
	 */
	@Override
	public NamedSetFieldMessage deserialize(JsonElement jsonMessage, Type type,
		...
		return new NamedSetFieldMessage(name, index, value, zeroBased,
				sudokuWidth, sudokuHeight, customValues, customProperties);
	}

	/**
	 * Serialize the given {@link NamedSetFieldMessage} into a
	 * {@link JsonElement}.
	 * 
	 * @param message
	 ...
	 */
	@Override
	public JsonElement serialize(NamedSetFieldMessage message, Type type,
