...
/**
 * This message is sent to tell the receiver that the described field should be
 * set to the value passed within the message.
 * 
 * @author dalhai
 * 
 */
public class SetFieldMessage extends Message {
    ...
    /**
     * The assumed width of a sudoku field when not provided other values.
     */
    public static final int DEFAULT_SUDOKU_WIDTH = 9;

    /**
     * The assumed height of a sudoku field when not provided other values.
     */
    ...
    public SetFieldMessage(int row, int column, int value, boolean zeroBased) {
        this(row, column, value, zeroBased, DEFAULT_SUDOKU_WIDTH,
    ...
    public SetFieldMessage(int row, int column, int value, boolean zeroBased,
        ...
        this(zeroBased ? row * sudokuWidth + column : (row - 1) * sudokuWidth
                + column, value, zeroBased, sudokuWidth, sudokuHeight);
    }
    ...
    public SetFieldMessage(int index, int value, boolean zeroBased) {
        this(index, value, zeroBased, DEFAULT_SUDOKU_WIDTH,
                DEFAULT_SUDOKU_HEIGHT);
    }
     ...
     */
    public SetFieldMessage(int index, int value, boolean zeroBased,
            int sudokuWidth, int sudokuHeight, List<String> customValues,
